 ...
 */
final class Version20230208092321 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE meal DROP photo');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE meal ADD photo LONGBLOB NOT NULL');
    }
}
