...
class CalendarController extends AbstractController
{
    ...
    public function index(CalendarRepository $calendarRepository,OpeningTimeRepository $openingTimeRepository): Response
    {
    ...
    public function new(Request $request, CalendarRepository $calendarRepository,OpeningTimeRepository $openingTimeRepository): Response
    {
